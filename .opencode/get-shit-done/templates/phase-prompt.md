...
<!-- For checkpoint task examples and patterns, see @D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/references/checkpoints.md -->
...
See `D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
