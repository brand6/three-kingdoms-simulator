...
- Usage: Reference from command with `@D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Projects/Godot/三国模拟器/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Projects/Godot/三国模拟器/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
