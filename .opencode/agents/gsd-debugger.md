...
- use the godot-remote-executor skill first to check or modify files in the godot engine
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks D:/Projects/Godot/三国模拟器/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Projects/Godot/三国模拟器/.opencode/get-shit-done
                  → writes to D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Projects/Godot/三国模拟器/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
